<?php
    ...
    class PDF extends FPDF {
        ...
        function morepagestable($datas, $lineheight=15) {
            ...
            foreach($datas AS $row => $data) {
                ...
                foreach($data AS $col => $txt) {
                    ...
                    //Se hizo un cambio aquí FJ
                    if ($row==0) {
                        $this->SetFont('Arial','B',12);
                        $this->MultiCell($this->tablewidths[$col],20,utf8_decode($txt),0,'C');
                    }else{
                        $this->SetFont('Arial','',10);
                        $this->MultiCell($this->tablewidths[$col],$lineheight,$txt,0,($col>1?'J':'C'));
                    }
